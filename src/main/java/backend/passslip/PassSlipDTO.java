...
public class PassSlipDTO {
    ...
    private LocalDateTime timeRequested; // NEW FIELD
    private LocalDateTime timeOut;       // Now nullable
    ...
    public PassSlipDTO(String slipId, String employeeId, String destination, String reason,
                       LocalDateTime timeRequested, LocalDateTime timeOut, LocalDateTime timeIn,
    ...
    // Getters and Setters for timeRequested
    public LocalDateTime getTimeRequested() { return timeRequested; }
    public void setTimeRequested(LocalDateTime timeRequested) { this.timeRequested = timeRequested; }
