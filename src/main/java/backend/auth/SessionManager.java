...
public final class SessionManager {
    ...
    // Store role and username for UI routing and unlocking
    ...
    // FIXED: Standard public getter returning the private field
    public String getCurrentUsername() {
        return currentUsername;
    }

    // FIXED: Added missing timeout method to fix Login/BaseSettings compiler errors
