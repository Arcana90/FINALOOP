    ...
    public class WeeklyReportExporter {
        ...
        public static void exportToPdf(File file, String weekName, List<DailyActivitySummary> dailySummaries,
            ...
            // Display the specific week chosen
            document.add(new Paragraph("WEEKLY PASS SLIP OPERATIONAL REPORT: " + weekName, headerFont));
        ...
        public static void exportToCsv(File file,
            ...
            try (PrintWriter writer = new PrintWriter(file)) {
                // 🟢 Add the weekName to the title
                writer.println("WEEKLY PASS SLIP OPERATIONAL REPORT: " + weekName);
